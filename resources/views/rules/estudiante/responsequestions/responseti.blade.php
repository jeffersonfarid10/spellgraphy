<x-app-layout>
    ...
    <!-- /////////////////////////////////////////////////////////////NUEVA VISTA RESPONDER PREGUNTA TI//////////////////////////////// -->
    ...
    <div class="bg-white">
        ...
        <div class="container mx-auto pt-24 p-12">
            ...
            EN LA COLUMNA DE LA IZQUIERDA SE COLOCAN LAS REGLAS ORTOGRÁFICAS Y EN LA COLUMNA DE LA DERECHA EL EJERCICIO -->
            <!-- CON UN EL ISSET SE PREGUNTA SI ESTA ENVIANDO INFORMACION DE REGLAS ORTOGRAFICAS, LO QUE SIGNIFICA QUE EL USUARIO ESTA EN ALGUNA DE LAS ACTIVIDADES DE PRACTICA
                    ...
                    <div class="container mt-10 w-full mx-auto bg-amber-100 shadow-lg rounded-3xl border border-gray-200">
                        ...
                        <div class="container mx-auto mt-10 rounded">
                            <form action="{{route('estudiante.save.ti')}}" method="POST">
                                @csrf 
                                <div class="w-full mx-auto bg-amber-100 rounded">
            ...
            @else 
                <!-- SI ESTA EN LA EVALUACION DE DIAGNOSTICO O FINAL SOLO SE MUESTRA LA COLUMNA DE LA DERECHA -->
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <!-- COLUMNA QUE MUESTRA LA IMAGEN DEL TEXTO -->
                    <div class="container mt-10 w-full mx-auto bg-amber-100 shadow-lg rounded-3xl border border-gray-200">
                        <header class="px-5 pt-4 mb-4">
                    ...
                    <!-- COLUMNA QUE CONTIENE A LA CASILLA PARA ESCRIBIR EL TEXTO -->
                    <div class="container mt-10 w-full mx-auto bg-amber-100 shadow-lg rounded-3xl border border-gray-200">
                        <header class="px-5 pt-4 mb-4">
                            <h2 class="font-semibold font-sora text-red-500 text-center text-2xl">Responda a la pregunta</h2>
                        </header>
           ...
           {{--@isset ($question->rule)
                <div class="container mx-auto mt-10 rounded">
                    <div class="w-full mx-auto bg-white shadow-lg rounded-3xl border border-gray-200">
                        <header class="px-5 py-4 border-b border-gray-100">
                            <h2 class="font-semibold text-red-500 font-sora text-2xl">Tome en cuenta las siguiente información para responder a la pregunta:</h2>
                        </header>
            --}}
                        <!-- PARA MOSTRAR EL TEXTO DE CK EDITOR CON LOS ESTILOS SE CORRE EL SIGUIENTE COMANDO -->
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
            {{--          <div class="mx-auto p-5 overflow-auto prose lg:prose-xl text-justify">
                            {!!$question->rule!!}
                      </div>
                    </div>
                </div>
    ...
    <!-- /////////////////////////////////////////////////////////////////FIN NUEVA VISTA RESPONDER PREGUNTA TI////////////////////////////////// -->
