<x-app-layout>
    ...
    <!-- ////////////////////////////////////////////////////////////////NUEVA VISTA RESPONDER PREGUNTA OMI////////////////////////////// -->

    <!-- SE CREA UN DIV PADRE QUE VA A SER DE COLOR BLANCO -->
    <div class="bg-white">

        <!-- SE CREA UN DIV HIJO CON CLASS CONTAINER Y QUE DEBE TENER OBLIGATORIAMENTE UN PT-24 PORQUE SINO EL NAVBAR VA A OCULTAR LA INFORMACION -->
        <div class="container mx-auto pt-24 p-12">
            ...
            <!-- CON UN ISSET SE PREGUNTA SI ESTA ENVIANDO INFORMACION DE REGLAS ORTOGRAFICAS, LO QUE SIGNIFICA QUE EL USUARIO ESTA EN ALGUNA DE LAS ACTIVIDADES
            DE PRACTICA, SI ES ASI SE MUESTRA DOS COLUMNAS, CASO CONTRARIO SOLO MUESTRA LA COLUMNA DE RESPONDER PREGUNTA -->
            @isset($question->rule)
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="container mt-10 w-full mx-auto bg-amber-100 shadow-lg rounded-3xl border border-gray-200">
                        ...
                        <!-- DIV QUE CONTIENE LAS OPCIONES DE RESPUESTA -->
                            <div class="ontainer mx-auto mt-10 rounded">
            ...
            @else 
                <!-- SI EL USUARIO ESTA EN LA EVALUACION DE DIAGNOSTICO O EVALUACION FINAL EN UNA COLUMA APARECE LA IMAGEN Y EN OTRA APARECE LA SECCION PARA RESPONDER
                A LA PREGUNTA -->
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <!-- COLUMA PARA RESPONDER A LA PREGUNTA -->
                    <div class="container mt-10 w-full mx-auto bg-amber-100 shadow-lg rounded-3xl border border-gray-200">
                        <header class="px-5 pt-4 mb-4">
                            <h2 class="font-semibold font-sora text-red-500 text-center text-2xl">Responda a la pregunta:</h2>
                        </header>
    ...
    <!-- ///////////////////////////////////////////////////////////////////FIN VISTA RESPONDER PREGUNTA OMI//////////////////////////////////////// -->
