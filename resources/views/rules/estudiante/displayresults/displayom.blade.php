<x-app-layout>
    ...
    <!-- /////////////////////////////////////////////////////////////////////NUEVA VISTA RESULTADOS PREGUNTA OM//////////////////////////////// -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-800 rounded">
                    ...
                    <div class="container mx-auto p-5">
                        ...
                        @foreach ($answersUser as $result)
                            <h4 class="font-semibold text-gray-800 font-sora text-center text-2xl">{{$result->answer_user}}</h4>
                        @endforeach
    ...
    <!-- ///////////////////////////////////////////////////////////////////////FIN NUEVA VISTA RESULTADOS PREGUNTA OM////////////////////////////// -->
