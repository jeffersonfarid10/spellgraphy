<x-app-layout>
        ...
        <div class="container mx-auto pt-24 p-12">
            ...
            <div class="container mt-10 w-full mx-auto bg-white shadow-lg rounded-3xl border border-gray-600">
                ...
                <div class="px-5 py-4 border-b border-gray-100">
                    ...
                    <h4 class="font-semibold text-gray-800 font-sora text-center text-xl">{{$respuestaTextoUno}}</h4>
                </div>
                    ...
                    <div class="grid grid-cols-1 border-2">
                        ...
                        MENSAJE QUE HAY ESPACIOS ADICIONALES EN LA RESPUESTA, PERO SI ES FALSE, ES DECIR NO TIENE ESPACIOS, SOLO SE MUESTRA LA RESPUESTA DEL USUARIO -->
                            @if ($existenespacios)
                                ...
                                <h4 class="font-semibold text-gray-800 font-sora text-justify text-2xl m-4">{{$stringseccionestextotausuario}}</h4>
                    ...
                    <div class="grid grid-cols-1 border-2 p-4">
                        ...
                        <div>
                            ...
                            @foreach (array_unique($resultadoSeccionesTextoUsuarioIncorrectas) as $key=>$elemento)
                                <span id="palabrasIncorrectasTextoUsuario" name="palabrasIncorrectasTextoUsuario" class="font-semibold text-gray-800 font-sora text-center text-xl md:text-2xl ml-4">{{$elemento}}</span>
                                <span class="font-semibold text-red-500 font-sora text-center text-xl md:text-2xl ml-4"> | </span>
                    ...
                    <div class="grid grid-cols-1 border-2 p-4">
                        ...
                        <div>
                            ...
                            @foreach ($resultadoSignosIncorrectosTextoUsuario as $elemento)
                                <span id="signosIncorrectosTextoUsuario" name="signosIncorrectosTextoUsuario" class="font-semibold text-gray-800 font-sora text-center text-xl md:text-2xl ml-4">{{$elemento}}</span>
                                <span class="font-semibold text-red-500 font-sora text-center text-xl md:text-2xl ml-4"> | </span>
                        ...
                        <table class="table-auto w-full">
                            <thead class=" bg-gray-200 rounded-2xl">
                                <tr>
                                    ...
                                    <th class="p-2 whitespace-nowrap">
                                        <div class=" text-center font-bold font-sora text-red-500 mt-4 ml-4 mb-5 text-xl">Explicación a la regla ortográfica:</div>
                                    </th>
                                </tr>
                            </thead>
    ...
    <!-- /////////////////////////////////////////////////////////////FIN NUEVA VISTA RESULTADOS TA//////////////////////////////////// -->


    

    <!-- SCRIPT JUEGO -->
    <script src="{{asset('/js/resaltarta.js')}}"></script>
</x-app-layout>