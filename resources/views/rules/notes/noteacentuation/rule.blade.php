<x-app-layout>
    ...
    <!-- /////////////////////////////////////////NUEVA VISTA REGLAS ORTOGRAFICAS DE ACENTUACION NIVEL 5 NOTES///////////////////////////// -->
    ...
    <div class="bg-white">
        ...
        <div class="container mx-auto pt-24 rounded-xl p-12">
            ...
            <h1 class="mb-4 text-3xl font-extrabold md:text-5xl lg:text-6xl text-center font-anton tracking-wide"><span class="text-blue-700">{{$noteacentuationObject->name}}</span></h1>
        </div>
        ...
        <div class="container">
            ...
            <div>
                ...
                >
                <!-- REGLA NIVEL CUATRO -->
                <a href="/estudiante/acentuation/{{$categoryacentuationObject->slug}}/{{$sectionacentuationObject->slug}}/{{$postacentuationObject->slug}}/{{$ruleacentuationObject->slug}}" class="inline-block">
                    <p class="leading-relaxed font-sora font-semibold text-gray-800">{{$ruleacentuationObject->name}}</p>
                </a>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                @isset($noteacentuationObject->image)
                    <div class="container mx-auto p-10">
                        <div class="w-4/5 mx-auto">
                            ...
                            <img id="image" name="image" src="/storage/{{$noteacentuationObject->image}}" alt="" class="w-full h-full object-cover object-center rounded-lg ">
                        </div>
                    </div> 
                @endisset
                ...
                @if (count($noteacentuationObject->words) > 0)
                    <div class="container mx-auto p-10 bg-amber-200 rounded-xl mt-10">
                        ...
                        <div class="overflow-auto">
                            ...
                            @foreach ($noteacentuationObject->words as $word)
                                <!--  TERMINOS-->
                ...
                <!-- CAMPO EXAMPLE -->
                @isset($noteacentuationObject->example)
                    <div class="container mx-auto p-10">
                        <!-- PARA MOSTRAR EL TEXTO DE CK EDITOR CON LOS ESTILOS SE CORRE EL SIGUIENTE COMANDO -->
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="p-4 ml-5 md:ml-10 lg:ml-20 overflow-auto prose lg:prose-2xl text-justify">
                            {!!$noteacentuationObject->example!!}
                        </div>
                    </div>
                @endisset
                ...
                <!-- CAMPO EXCEPTION -->    
                @isset($noteacentuationObject->exception)
                    <div class="container mx-auto p-10">
                        <!-- PARA MOSTRAR EL TEXTO DE CK EDITOR CON LOS ESTILOS SE CORRE EL SIGUIENTE COMANDO -->
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="p-4 ml-5 md:ml-10 lg:ml-20 overflow-auto prose lg:prose-2xl text-justify">
                            {!!$noteacentuationObject->exception!!}
                        </div>
                    </div> 
                @endisset
            ...
            <div class="col-span-1">
                ...
                <div class="bg-slate-900 h-full rounded-3xl px-5 py-10">
                    ...
                    <div class="bg-indigo-300 rounded-xl mb-4">
                        <h2 class="pl-3 pt-3 text-black font-semibold font-sora">Más reglas ortográficas de: " {{$ruleacentuationObject->name}} "</h2>
                        <div class="p-3 grid grid-cols-1 divide-y divide-yellow-400">
                            ...
                            @foreach ($sugerenciasnivelcinco as $sugerencia)
                                ...
                                <a href="/estudiante/acentuation/{{$categoryacentuationObject->slug}}/{{$sectionacentuationObject->slug}}/{{$postacentuationObject->slug}}/{{$sugerencia->rule->slug}}/{{$sugerencia->slug}}">
    ...
    <!-- //////////////////////////////////////////////FIN NUEVA VISTA REGLAS ORTOGRAFICAS DE ACENTUACION NIVEL 5 NOTES/////////////////////////////// -->


    <!-- VISTA REGLAS ORTOGRAFICAS DE ACENTUACION NIVEL 5 ORIGINAL -->

    <!-- NOMBRE DE LA REGLA POST -->
    <h1 class="bg-blue-900 text-6xl text-white text-center"><strong>{{$noteacentuationObject->name}}</strong></h1>
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div>
            ...
            <br>
            <a href="/estudiante/acentuation/{{$categoryacentuationObject->slug}}/{{$sectionacentuationObject->slug}}/{{$postacentuationObject->slug}}/{{$ruleacentuationObject->slug}}"><strong class="text-emerald-500">{{$ruleacentuationObject->name}}</strong></a>
        ...
        <br>
            ...
            <div class="col-span-2">
                ...
                @isset($noteacentuationObject->image)
                    <img id="image" name="image" src="/storage/{{$noteacentuationObject->image}}" alt="" height="400px" width="700px">
                @endisset
                ...
                <div>
                    ...
                    {{-- npm install -D @tailwindcss/typography --}}
                    <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                    <div class="prose lg:prose-xl">{!!$noteacentuationObject->body!!}</div>
                </div>
                ...
                @isset($noteacentuationObject->example)
                    <div>
                        ...
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="prose lg:prose-xl">{!!$noteacentuationObject->example!!}</div>
                    </div>
                @endisset
                ...
                @isset($noteacentuationObject->exception)
                    ...
                    {{-- npm install -D @tailwindcss/typography --}}
                    <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                    <div class="prose lg:prose-xl">{!!$noteacentuationObject->exception!!}</div>
                @endisset
            ...
            <aside>
                ...
                <div class="bg-indigo-300">
                    ...
                    <strong class="text-red-500 my-3">Más reglas ortográficas de: "{{$ruleacentuationObject->name}}"</strong>
                    <br>
                    @foreach ($sugerenciasnivelcinco as $sugerencia)
                        <div class="mb-4">
