<x-app-layout>
    ...
    <!-- //////////////////////////////////////////////////NUEVA VISTA REGLAS ORTOGRAFICAS DE PUNTUACION NIVEL 5 NOTES/////////////////////// -->
    ...
    <div class="bg-white">
        ...
        <div class="container mx-auto pt-24 rounded-xl p-12">
            ...
            <h1 class="mb-4 text-3xl font-extrabold md:text-5xl lg:text-6xl text-center font-anton tracking-wide"><span class="text-green-700">{{$notepunctuationObject->name}}</span></h1>
        </div>
        ...
        <div class="container">
            ...
            <div>
                ...
                >
                <!-- REGLA NIVEL TRES -->
                <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}/{{$sectionpunctuationObject->slug}}/{{$postpunctuationObject->slug}}" class="inline-block">
                    <p class="leading-relaxed font-sora font-semibold text-gray-800">{{$postpunctuationObject->name}}</p>
                </a>
                >
                <!-- REGLA NIVEL CUATRO -->
                <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}/{{$sectionpunctuationObject->slug}}/{{$postpunctuationObject->slug}}/{{$rulepunctuationObject->slug}}" class="inline-block">
                    <p class="leading-relaxed font-sora font-semibold text-gray-800">{{$rulepunctuationObject->name}}</p>
                </a>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                @isset($notepunctuationObject->image)
                    <div class="container mx-auto p-10">
                        <div class="w-4/5 mx-auto">
                            ...
                            <img id="image" name="image" src="/storage/{{$notepunctuationObject->image}}" alt="" class="w-full h-full object-cover object-center rounded-lg ">
                        </div>
                    </div> 
                @endisset
                ...
                @if (count($notepunctuationObject->words) > 0)
                    <div class="container mx-auto p-10 bg-amber-200 rounded-xl mt-10">
                        ...
                        <div class="overflow-auto">
                            ...
                            @foreach ($notepunctuationObject->words as $word)
                                <!--  TERMINOS-->
                ...
                <!-- CAMPO EXAMPLE -->
                @isset($notepunctuationObject->example)
                    <div class="container mx-auto p-10">
                        <!-- PARA MOSTRAR EL TEXTO DE CK EDITOR CON LOS ESTILOS SE CORRE EL SIGUIENTE COMANDO -->
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="p-4 ml-5 md:ml-10 lg:ml-20 overflow-auto prose lg:prose-2xl text-justify">
                            {!!$notepunctuationObject->example!!}
                        </div>
                    </div>
                @endisset
                ...
                <!-- CAMPO EXCEPTION -->    
                @isset($notepunctuationObject->exception)
                    <div class="container mx-auto p-10">
                        <!-- PARA MOSTRAR EL TEXTO DE CK EDITOR CON LOS ESTILOS SE CORRE EL SIGUIENTE COMANDO -->
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="p-4 ml-5 md:ml-10 lg:ml-20 overflow-auto prose lg:prose-2xl text-justify">
                            {!!$notepunctuationObject->exception!!}
                        </div>
                    </div> 
                @endisset
            ...
            <div class="col-span-1">
                ...
                <div class="bg-slate-900 h-full rounded-3xl px-5 py-10">
                    ...
                    <div class="bg-indigo-300 rounded-xl mb-4">
                        <h2 class="pl-3 pt-3 text-black font-semibold font-sora">Más reglas ortográficas de: " {{$rulepunctuationObject->name}} "</h2>
                        <div class="p-3 grid grid-cols-1 divide-y divide-yellow-400">
                            ...
                            @foreach ($sugerenciasnivelcinco as $sugerencia)
                                ...
                                <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}/{{$sectionpunctuationObject->slug}}/{{$postpunctuationObject->slug}}/{{$sugerencia->rule->slug}}/{{$sugerencia->slug}}">
                    ...
                    <div class="bg-green-300 rounded-xl mb-4">
                        <h2 class="pl-3 pt-3 text-black font-semibold font-sora">Más reglas ortográficas de: " {{$postpunctuationObject->name}} "</h2>
                        <div class="p-3 grid grid-cols-1 divide-y divide-yellow-400">

                            <!-- SE RECORREN LAS REGLAS SIMILARES -->
                            @foreach ($sugerenciasnivelcuatro as $sugerencia)

                                <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}/{{$sectionpunctuationObject->slug}}/{{$sugerencia->post->slug}}/{{$sugerencia->slug}}">
                                    <div class="py-8 flex flex-wrap md:flex-nowrap">
                                        <div class="md:flex-grow">
                                            <h2 class="text-xl font-bold text-black title-font font-sora mb-1">{{$sugerencia->name}}</h2>
                                            <!-- CON EL ISSET SE MUESTRA LA DESCRIPCION SI ESTA EXISTE -->
    ...
    <!-- //////////////////////////////////////////////////////FINAL VISTA REGLAS ORTOGRAFICAS DE PUNTUACION NIVEL 5 NOTES/////////////////////////////// -->

    <!-- NOMBRE DE LA REGLA POST -->
    <h1 class="bg-green-900 text-6xl text-white text-center"><strong>{{$notepunctuationObject->name}}</strong></h1>
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div>
            Regresar a: 
            <br>
            <a href="/estudiante/punctuation"><strong class="text-amber-600">{{$categorypunctuationObject->type}}</strong></a>
            <br>
            <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}"><strong class="text-cyan-700">{{$categorypunctuationObject->name}}</strong></a>
            <br>
            <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}/{{$sectionpunctuationObject->slug}}"><strong class="text-green-700">{{$sectionpunctuationObject->name}}</strong></a>
            <br>
            <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}/{{$sectionpunctuationObject->slug}}/{{$postpunctuationObject->slug}}"><strong class="text-pink-600">{{$postpunctuationObject->name}}</strong></a>
            <br>
            <a href="/estudiante/punctuation/{{$categorypunctuationObject->slug}}/{{$sectionpunctuationObject->slug}}/{{$postpunctuationObject->slug}}/{{$rulepunctuationObject->slug}}"><strong class="text-emerald-500">{{$rulepunctuationObject->name}}</strong></a>
        ...
        <br>
            ...
            <div class="col-span-2">
                ...
                @isset($notepunctuationObject->image)
                    <img id="image" name="image" src="/storage/{{$notepunctuationObject->image}}" alt="" height="400px" width="700px">
                @endisset
                ...
                <div>
                    ...
                    {{-- npm install -D @tailwindcss/typography --}}
                    <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                    <div class="prose lg:prose-xl">{!!$notepunctuationObject->body!!}</div>
                </div>
                ...
                @isset($notepunctuationObject->example)
                    <div>
                        ...
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="prose lg:prose-xl">{!!$notepunctuationObject->example!!}</div>
                    </div>
                @endisset
                ...
                @isset($notepunctuationObject->exception)
                    ...
                    {{-- npm install -D @tailwindcss/typography --}}
                    <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                    <div class="prose lg:prose-xl">{!!$notepunctuationObject->exception!!}</div>
                @endisset
            ...
            <aside>
                ...
                <div class="bg-amber-300">
                    ...
                    <strong class="text-red-500 my-3">Más reglas ortográficas de: "{{$rulepunctuationObject->name}}"</strong>
                    <br>
                    @foreach ($sugerenciasnivelcinco as $sugerencia)
                        <div class="mb-4">
                ...
                <div class="bg-teal-300">
                    <strong class="text-red-500 my-5">Más reglas ortográficas de: "{{$postpunctuationObject->name}}"</strong>
                    <br>
                    @foreach ($sugerenciasnivelcuatro as $sugerencia)
                        <div class="mb-4">
                            <!-- EN LA HREF SE ENVIA EL SLUG DE LA CATEGORIA NIVEL 1 (CATEGORY) A LA QUE PERTENECE ESTA REGLA NIVEL 2 (SECTION) 
                ...
                <div class="bg-sky-300">
                    <strong class="text-red-500 my-5">Más reglas ortográficas de: "{{$sectionpunctuationObject->name}}"</strong>
                    <br>
                    @foreach ($sugerenciasniveltres as $sugerencia)
                        <div class="mb-4">
                            <!-- EN LA HREF SE ENVIA EL SLUG DE LA CATEGORIA NIVEL 1 (CATEGORY) A LA QUE PERTENECE ESTA REGLA NIVEL 2 (SECTION)
                ...
                <div class="bg-orange-200">
                    <strong class="text-red-500 my-5">Más reglas ortográficas de: "{{$categorypunctuationObject->name}}"</strong>
                    <br>
                    @foreach ($sugerenciasniveldos as $sugerencia)
                        <div class="mb-4">
                            <!-- EN LA HREF SE ENVIA EL SLUG DE LA CATEGORIA NIVEL 1 (CATEGORY) A LA QUE PERTENECE ESTA REGLA NIVEL 2 (SECTION)
                ...
                <div class="bg-amber-200">
                    <strong class="text-red-500 my-5">Más reglas ortográficas de: "{{$categorypunctuationObject->type}}"</strong>
                    <br>
                    @foreach ($sugerenciasniveluno as $sugerencia)
                        <div class="mb-4">
