<x-app-layout>
    ...
    <!-- /////////////////////////////////////////////////////NUEVA VISTA REGLAS ORTOGRAFICAS DE PALABRAS NIVEL 3 POSTS ////////////////////////////-->
    ...
    <div class="bg-white">
        ...
        <div class="container mx-auto pt-24 rounded-xl p-12">
            ...
            <h1 class="mb-4 text-3xl font-extrabold md:text-5xl lg:text-6xl text-center font-anton tracking-wide"><span class="text-red-700">{{$postwordObject->name}}</span></h1>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                @isset($postwordObject->image)
                    <div class="container mx-auto p-10">
                        <div class="w-4/5 mx-auto">
                            ...
                            <img id="image" name="image" src="/storage/{{$postwordObject->image}}" alt="" class="w-full h-full object-cover object-center rounded-lg ">
                        </div>
                    </div> 
                @endisset
                ...
                @if (count($postwordObject->words) > 0)
                    <div class="container mx-auto p-10 bg-amber-200 rounded-xl mt-10">
                        ...
                        <div class="overflow-auto">
                            ...
                            @foreach ($postwordObject->words as $word)
                                <!--  TERMINOS-->
                ...
                <!-- CAMPO EXAMPLE -->
                @isset($postwordObject->example)
                    <div class="container mx-auto p-10">
                        <!-- PARA MOSTRAR EL TEXTO DE CK EDITOR CON LOS ESTILOS SE CORRE EL SIGUIENTE COMANDO -->
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="p-4 ml-5 md:ml-10 lg:ml-20 overflow-auto prose lg:prose-2xl text-justify">
                            {!!$postwordObject->example!!}
                        </div>
                    </div>
                @endisset
                ...
                <!-- CAMPO EXCEPTION -->    
                @isset($postwordObject->exception)
                    <div class="container mx-auto p-10">
                        <!-- PARA MOSTRAR EL TEXTO DE CK EDITOR CON LOS ESTILOS SE CORRE EL SIGUIENTE COMANDO -->
                        {{-- npm install -D @tailwindcss/typography --}}
                        <!-- Y SE DEBE CREAR UN DIV CON LA CLASE:  class="prose lg:prose-xl" -->
                        <div class="p-4 ml-5 md:ml-10 lg:ml-20 overflow-auto prose lg:prose-2xl text-justify">
                            {!!$postwordObject->exception!!}
                        </div>
                    </div> 
                @endisset
                ...
                @if (count($postwordObject->rules) > 0)
                        ...
                        <p class="text-xl font-sora m-5 font-semibold">Haz click en la regla ortográfica de tu interés para acceder a información más detallada.</p>
                            ...
                            <div class="container px-5 py-4 mx-auto">
                                <div class="grid grid-cols-1 divide-y divide-slate-800">
                                    ...
                                    @foreach ($postwordObject->rules as $ruleword)
                                            <!-- REGLAS ORTOGRAFICAS DISPONIBLES -->
                                                ...
                                                <a href="/estudiante/letters/{{$categorywordObject->slug}}/{{$sectionwordObject->slug}}/{{$postwordObject->slug}}/{{$ruleword->slug}}">
                                                    <div class="py-8 flex flex-wrap md:flex-nowrap">
                                                        <div class="md:flex-grow">
                                                            <h2 class="text-2xl font-bold text-red-500 title-font font-sora mb-2">{{$ruleword->name}}</h2>
                                                            <!-- CON EL ISSET SE MUESTRA LA DESCRIPTION QUE ES OPCIONAL PARA LAS REGLAS DE NIVEL 3 -->
                                                            @isset($ruleword->description)
                                                                <p>{!!$ruleword->description!!}</p>
                                                            @endisset
                                                        </div>
                                                    </div>
                                                </a>
    ...
    <!-- //////////////////////////////////////////////////////////FIN NUEVA VISTA REGLAS ORTOGRAFICAS DE PALABRAS NIVEL 3 POSTS ///////////////////////////////-->
