...
@section('content_header')
    <h1 class="text-white bg-dark font-bold pl-3">Gestión de reglas ortográficas nivel uno</h1>
@stop
...
<div class="m-4">
        ...
        <div class="col">
            <div class="card m-5">
                <div class="card-header text-white bg-gray-dark">
                    Reglas ortográficas de palabras nivel 1
                </div>
                <div class="card-body">
                    <br>
    ...
    <div class="row">
        <div class="col">
            <div class="card m-5">
                <div class="card-header text-white bg-gray-dark">
                    Reglas ortográficas de acentuación nivel 1
                </div>
                <div class="card-body">
                    <br>
    ...
    <div class="row">
        <div class="col">
            <div class="card m-5">
                <div class="card-header text-white bg-gray-dark">
                    Reglas ortográficas de puntuación nivel 1
                </div>
                <div class="card-body">
                    <br>
