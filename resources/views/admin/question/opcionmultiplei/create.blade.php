...
@section('content_header')
    <h1>Crear pregunta opción múltiple con imagen</h1>
@stop
...
<div class="card">
    <div class="card-header">
        ...
        <div class="bg-dark text-white font-bold rounded">
            <a href="{{route('admin.question.opcionmultiplei.index')}}">
    ...
    @endif
    <div class="card-body">
        <form action="{{route('admin.question.opcionmultiplei.store')}}" method="POST" enctype="multipart/form-data">
            @csrf 
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($opcionmultiple->image)
                                <img id="picture" src="{{Storage::url($opcionmultiple->image)}}" alt="">
                            @else 
