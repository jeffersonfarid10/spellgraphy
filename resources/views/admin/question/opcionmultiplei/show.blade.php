...
<div class="card">
    <div class="card-header">
        ...
        <br><h1 class="card-title">{{$opcionmultiplei->title}}</h1>
    </div>
    <div class="card-body">
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                ...
                <br>
                <h1 class="card-title">{{$opcionmultiplei->evaluation->name}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Grupo al que pertenece:</strong>
                <br>
                <h1 class="card-title">{{$opcionmultiplei->evaluation->format}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Indicaciones:</strong>
                <br>
                @foreach ($opcionmultiplei->indications as $key=>$indicacion)
            ...
            <li class="list-group-item">
                ...
                <br>
                <img id="image" name="image" src="/storage/{{$opcionmultiplei->image}}" alt="" height="400px" width="700px">
            </li>
            <li class="list-group-item">
    ...
    <div class="card-footer">
        ...
        <div class="row">
            ...
            @if (count($opcionmultiplei->categories) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel uno:</strong>
                    <br>
                    @foreach ($opcionmultiplei->categories as $categoryrule)
                        <br>
            ...
            @if (count($opcionmultiplei->sections) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel dos:</strong>
                    <br>
                    @foreach ($opcionmultiplei->sections as $sectionrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($opcionmultiplei->posts) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel tres:</strong>
                    <br>
                    @foreach ($opcionmultiplei->posts as $postrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($opcionmultiplei->rules) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cuatro:</strong>
                    <br>
                    @foreach ($opcionmultiplei->rules as $rulerule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
            ...
            @if (count($opcionmultiplei->notes) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cinco:</strong>
                    <br>
                    @foreach ($opcionmultiplei->notes as $noterule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
