...
<div class="bg-dark text-white font-bold rounded">
    <a href="{{route('admin.question.opcionmultiplei.index')}}"><button class="btn btn-info m-3">Volver al menú principal</button></a>
</div>
<div class="card"> 
    ...
    @endif
    <div class="card-body">
        <form action="{{route('admin.question.opcionmultiplei.update', $opcionmultiplei)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{method_field('PUT')}}

            <div class="form-group">
                <label>Enunciado de pregunta:</label>
                <input type="text" name="title" id="title" placeholder="Ingrese el enunciado de pregunta" value="{{$opcionmultiplei->title}}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" placeholder="Slug de la pregunta" value="{{$opcionmultiplei->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="evaluation_id" id="evaluation_id" class="form-control" required>
                    @foreach ($evaluations as $evaluation)
                        <option value="{{$evaluation->id}}" @if($evaluation->id==$opcionmultiplei->evaluation_id) selected @endif>{{$evaluation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <br>
                <textarea name="rule" id="rule" class="form-control" value="{{$opcionmultiplei->rule}}">{{$opcionmultiplei->rule}}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($opcionmultiplei->image)
                                <img id="picture" src="/storage/{{$opcionmultiplei->image}}" alt="">
                            @else 
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($opcionmultiplei->answers as $key=>$answer)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($opcionmultiplei->indications as $indication)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($opcionmultiplei->justifications as $justification)
                    <br>
