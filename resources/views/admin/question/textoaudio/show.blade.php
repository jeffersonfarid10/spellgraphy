...
<div class="card">
    <div class="card-header">
        ...
        <br><h1 class="card-title">{{$textoaudio->title}}</h1>
    </div>
    <div class="card-body">
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                ...
                <br>
                <h1 class="card-title">{{$textoaudio->evaluation->name}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Grupo al que pertenece:</strong>
                <br>
                <h1 class="card-title">{{$textoaudio->evaluation->format}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Indicaciones:</strong>
                <br>
                @foreach ($textoaudio->indications as $key=>$indicacion)
            ...
            @if ($textoaudio->rule)
                <li class="list-group-item">
                    ...
                    <br>
                    <p class="card-text">{!!$textoaudio->rule!!}</p>
                </li>
            @endif
            ...
            <li class="list-group-item">
                ...
                <br>
                <img id="image" name="image" src="/storage/{{$textoaudio->image}}" alt="" height="400px" width="700px">
            </li>
            <li class="list-group-item">
                <strong>Audio</strong>
                <br>
            ...
            <li class="list-group-item">
                ...
                <br>
                <div class="bg-white">
                    @foreach ($textoaudio->answers as $answer)
                        {{$answer->answer}}
                    @endforeach
                </div>
            </li>
            <li class="list-group-item">
                ...
                <div class="row m-3">
                    <div class="col">
                        ...
                        @foreach ($textoaudio->justifications as $key=>$justificacion)
     ...
     <div class="card-footer">
        ...
        <div class="row">
            ...
            @if (count($textoaudio->categories) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel uno:</strong>
                    <br>
                    @foreach ($textoaudio->categories as $categoryrule)
                        <br>
            ...
            @if (count($textoaudio->sections) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel dos:</strong>
                    <br>
                    @foreach ($textoaudio->sections as $sectionrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($textoaudio->posts) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel tres:</strong>
                    <br>
                    @foreach ($textoaudio->posts as $postrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($textoaudio->rules) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cuatro:</strong>
                    <br>
                    @foreach ($textoaudio->rules as $rulerule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
            ...
            @if (count($textoaudio->notes) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cinco:</strong>
                    <br>
                    @foreach ($textoaudio->notes as $noterule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
