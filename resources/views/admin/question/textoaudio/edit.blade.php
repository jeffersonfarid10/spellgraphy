...
<div class="card">
    ...
    @endif
    <div class="card-body">
        <form action="{{route('admin.question.textoaudio.update', $textoaudio)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{method_field('PUT')}}

            <div class="form-group">
                <label>Enunciado de pregunta:</label>
                <input type="text" name="title" id="title" placeholder="Ingrese el enunciado de pregunta" value="{{$textoaudio->title}}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" placeholder="Slug de la pregunta" value="{{$textoaudio->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="evaluation_id" id="evaluation_id" class="form-control" required>
                    @foreach ($evaluations as $evaluation)
                        <option value="{{$evaluation->id}}" @if($evaluation->id==$textoaudio->evaluation_id) selected @endif>{{$evaluation->name}}</option>
                    @endforeach
                </select>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($textoaudio->image)
                                <img id="picture" src="/storage/{{$textoaudio->image}}" alt="">
                            @else 
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <br>
                        <audio id="audio" name="audio" controls src="/storage/{{$textoaudio->audio}}" type="audio">Tu navegador no soporta este elemento, utiliza otro navegador.</audio>
                    </div>
                    <div class="col">
                        <label>Subir:</label>
            ...
            <div class="form-group">
                <label>Ingrese el texto correcto:</label>
                <br>
                @foreach ($textoaudio->answers as $key=>$answer)
                    <br>
                    <textarea name="answer" id="answer" class="form-control" value="{{$answer->answer}}" required>{{$answer->answer}}</textarea>
                    <br>
                @endforeach
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($textoaudio->indications as $indication)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($textoaudio->justifications as $justification)
                    <br>
