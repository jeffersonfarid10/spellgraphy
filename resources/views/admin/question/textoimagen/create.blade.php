...
@section('content_header')
    <h1>Crear pregunta texto con imagen</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.question.textoimagen.store')}}" method="POST" enctype="multipart/form-data">
            @csrf 
                    ...
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($oracionimagen->image)
                                <img id="picture" src="{{Storage::url($oracionimagen->image)}}" alt="">
                            @else 
            ...
            <div class="form-group">
                ...
                <br>
                <textarea name="answer" id="answer" value="{{old('answer')}}" required class="form-control"></textarea>
