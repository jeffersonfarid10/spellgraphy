...
<div class="card">
    ...
    @endif
    <div class="card-body">
        <form action="{{route('admin.question.textoimagen.update', $textoimagen)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{method_field('PUT')}}

            <div class="form-group">
                <label>Enunciado de pregunta:</label>
                <input type="text" name="title" id="title" placeholder="Ingrese el enunciado de pregunta" value="{{$textoimagen->title}}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" placeholder="Slug de la pregunta" value="{{$textoimagen->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="evaluation_id" id="evaluation_id" class="form-control" required>
                    @foreach ($evaluations as $evaluation)
                        <option value="{{$evaluation->id}}" @if($evaluation->id==$textoimagen->evaluation_id) selected @endif>{{$evaluation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <br>
                <textarea name="rule" id="rule" class="form-control" value="{{$textoimagen->rule}}">{{$textoimagen->rule}}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($textoimagen->image)
                                <img id="picture" src="/storage/{{$textoimagen->image}}" alt="">
                            @else 
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($textoimagen->answers as $key=>$answer)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($textoimagen->indications as $indication)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($textoimagen->justifications as $justification)
                    <br>
