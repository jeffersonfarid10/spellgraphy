...
<div class="bg-dark text-white font-bold rounded">
    <a href="{{route('admin.question.opcionmultiplea.index')}}"><button class="btn btn-info m-3">Volver al menú principal</button></a>
</div>
<div class="card">
    ...
    @endif
    <div class="card-body">
        <form action="{{route('admin.question.opcionmultiplea.update', $opcionmultiplea)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{method_field('PUT')}}

            <div class="form-group">
                <label>Enunciado de pregunta:</label>
                <input type="text" name="title" id="title" placeholder="Ingrese el enunciado de pregunta" value="{{$opcionmultiplea->title}}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" placeholder="Slug de la pregunta" value="{{$opcionmultiplea->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="evaluation_id" id="evaluation_id" class="form-control" required>
                    @foreach ($evaluations as $evaluation)
                        <option value="{{$evaluation->id}}" @if($evaluation->id==$opcionmultiplea->evaluation_id) selected @endif>{{$evaluation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <br>
                <textarea name="rule" id="rule" class="form-control" value="{{$opcionmultiplea->rule}}">{{$opcionmultiplea->rule}}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($opcionmultiplea->image)
                                <img id="picture" src="/storage/{{$opcionmultiplea->image}}" alt="">
                            @else 
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <br>
                        <audio id="audio" name="audio" controls src="/storage/{{$opcionmultiplea->audio}}" type="audio">Tu navegador no soporta este elemento, utiliza otro navegador.</audio>
                    </div>
                    <div class="col">
                        <label>Subir:</label>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($opcionmultiplea->answers as $key=>$answer)
                    <br>
                    <input type="text" name="opciones[]" class="form-control" value="{{$answer->answer}}">
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($opcionmultiplea->indications as $indication)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($opcionmultiplea->justifications as $justification)
                    <br>
