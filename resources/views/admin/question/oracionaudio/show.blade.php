...
<div class="card">
    <div class="card-header">
        ...
        <br><h1 class="card-title">{{$oracionaudio->title}}</h1>
    </div>
    <div class="card-body">
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                ...
                <br>
                <h1 class="card-title">{{$oracionaudio->evaluation->name}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Grupo al que pertenece:</strong>
                <br>
                <h1 class="card-title">{{$oracionaudio->evaluation->format}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Indicaciones:</strong>
                <br>
                @foreach ($oracionaudio->indications as $key=>$indicacion)
            ...
            @if ($oracionaudio->rule)
                <li class="list-group-item">
                    <strong>Información de reglas ortográficas:</strong>
                    <br>
                    <p class="card-text">{!!$oracionaudio->rule!!}</p>
                </li>
            @endif
            ...
            <li class="list-group-item">
                ...
                <br>
                <img id="image" name="image" src="/storage/{{$oracionaudio->image}}" alt="" height="400px" width="700px">
            </li>
            <li class="list-group-item">
                <strong>Audio</strong>
                <br>
            ...
            <li class="list-group-item">
                ...
                <div class="row m-3">
                    <div class="col">
                        ...
                        @foreach ($oracionaudio->justifications as $key=>$justificacion)
    ...
    <div class="card-footer">
        ...
        <div class="row">
            ...
            @if (count($oracionaudio->categories) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel uno:</strong>
                    <br>
                    @foreach ($oracionaudio->categories as $categoryrule)
                        <br>
            ...
            @if (count($oracionaudio->sections) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel dos:</strong>
                    <br>
                    @foreach ($oracionaudio->sections as $sectionrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($oracionaudio->posts) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel tres:</strong>
                    <br>
                    @foreach ($oracionaudio->posts as $postrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($oracionaudio->rules) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cuatro:</strong>
                    <br>
                    @foreach ($oracionaudio->rules as $rulerule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
            ...
            @if (count($oracionaudio->notes) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cinco:</strong>
                    <br>
                    @foreach ($oracionaudio->notes as $noterule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
