...
<div class="card">
    ...
    @endif
    <div class="card-body">
        <form action="{{route('admin.question.oracionaudio.update', $oracionaudio)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{method_field('PUT')}}

            <div class="form-group">
                <label>Enunciado de pregunta:</label>
                <input type="text" name="title" id="title" placeholder="Ingrese el enunciado de pregunta" value="{{$oracionaudio->title}}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" placeholder="Slug de la pregunta" value="{{$oracionaudio->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="evaluation_id" id="evaluation_id" class="form-control" required>
                    @foreach ($evaluations as $evaluation)
                        <option value="{{$evaluation->id}}" @if($evaluation->id==$oracionaudio->evaluation_id) selected @endif>{{$evaluation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <br>
                <textarea name="rule" id="rule" class="form-control" value="{{$oracionaudio->rule}}">{{$oracionaudio->rule}}</textarea>
                    ...
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($oracionaudio->image)
                                <img id="picture" src="/storage/{{$oracionaudio->image}}" alt="">
                            @else 
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <br>
                        <audio id="audio" name="audio" controls src="/storage/{{$oracionaudio->audio}}" type="audio">Tu navegador no soporta este elemento, utiliza otro navegador.</audio>
                    </div>
                    <div class="col">
                        <label>Subir:</label>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($oracionaudio->answers as $key=>$answer)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($oracionaudio->indications as $indication)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($oracionaudio->justifications as $justification)
                    <br>
