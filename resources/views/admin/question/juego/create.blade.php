...
@section('content_header')
    <h1>Crear pregunta juego ahorcado</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.question.juego.store')}}" method="POST" enctype="multipart/form-data">
            @csrf 
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" name="visible_answer" placeholder="Ingrese la oración visible al usuario" value="{{old('visible_answer')}}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" name="answer" placeholder="Ingrese la palabra a adivinar" value="{{old('answer')}}" class="form-control" required>
