...
<div class="card">
    <div class="card-header">
        ...
        <br><h1 class="card-title">{{$juego->title}}</h1>
    </div>
    <div class="card-body">
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                ...
                <br>
                <h1 class="card-title">{{$juego->evaluation->name}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Grupo al que pertenece:</strong>
                <br>
                <h1 class="card-title">{{$juego->evaluation->format}}</h1>
            </li>
            <li class="list-group-item">
                <strong>Indicaciones:</strong>
                <br>
                @foreach ($juego->indications as $key=>$indicacion)
            ...
            @if ($juego->rule)
                <li class="list-group-item">
                    ...
                    <br>
                    <p class="card-text">{!!$juego->rule!!}</p>
                </li>
            @endif

            <li class="list-group-item">
                <strong>Oracion visible al usuario:</strong>
                <br>
                <div class="bg-white">
            ...
            <li class="list-group-item">
                <strong>Palabra correcta:</strong>
                <br>
                <div class="bg-white">
                    @foreach ($juego->answers as $answer)
                        {{$answer->answer}}
            ...
            <li class="list-group-item">
                ...
                <div class="row m-3">
                    <div class="col">
                        ...
                        @foreach ($juego->justifications as $key=>$justificacion)
    ...
    <div class="card-footer">
        ...
        <div class="row">
            ...
            @if (count($juego->categories) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel uno:</strong>
                    <br>
                    @foreach ($juego->categories as $categoryrule)
                        <br>
            ...
            @if (count($juego->sections) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel dos:</strong>
                    <br>
                    @foreach ($juego->sections as $sectionrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($juego->posts) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel tres:</strong>
                    <br>
                    @foreach ($juego->posts as $postrule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
            ...
            @if (count($juego->rules) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cuatro:</strong>
                    <br>
                    @foreach ($juego->rules as $rulerule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
            ...
            @if (count($juego->notes) > 0)
                <div class="col">
                    <br>
                    <strong class="text-red">Reglas de nivel cinco:</strong>
                    <br>
                    @foreach ($juego->notes as $noterule)
                        <br>
                        <!-- CON EL IF SE PREGUNTA SI EL TYPE DE LA REGLA QUE SE RECORRE ES PALABRAS, ACENTUACION O PUNTUACION
                        SEGUN EL TYPE QUE SEA SE LE ENVIA A UNA RUTA DE NIVEL 3 DIFERENTE BASANDONOS EN LAS RUTAS DE WEB.PHP PARA MOSTRAR REGLAS ORTOGRAFICAS ESPECIFICAS -->
