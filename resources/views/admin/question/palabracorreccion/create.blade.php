...
@section('content_header')
    <h1>Crear pregunta corrección de palabras</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.question.palabracorreccion.store')}}" method="POST">
            @csrf 
            ...
            <div class="form-group">
                ...
                @for ($i=0; $i<15; $i++)
                    <div class="row">
                        <br>
                        <div class="col">
                            <input type="text" name="opciones[]" placeholder="Ingrese la palabra correcta {{$i+1}}" value="{{old('answer')}}" class="form-control" required>
                            <br>
                        </div>
                        <br>
                        <div class="col">
                            <input type="text" name="visibles[]" placeholder="Ingrese la palabra visible {{$i+1}}" value="{{old('visible_answer')}}" class="form-control" required>
                            <br>
                        </div>
