...
@section('content_header')
    <h1>Crear pregunta sopa de letras</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.question.sopaletras.store')}}" method="POST">
            @csrf 
            ...
            <div class="form-group">
                ...
                @for ($i=0; $i<30; $i++)
                    <div class="row">
                        ...
                        <br>
                        <div class="col">
                            <input type="text" name="visibles[]" placeholder="Ingrese la palabra incorrecta {{$i+1}}" value="{{old('visible_answer')}}" class="form-control" required>
                            <br>
                        </div>
                        <div class="col">
                            <input type="text" name="oraciones[]" placeholder="Ingrese la oración {{$i+1}}" value="{{old('second_answer')}}" class="form-control" required>
                            <br>
                        </div>
                    </div>
                @endfor
