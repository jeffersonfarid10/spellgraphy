...
<div class="bg-dark text-white font-bold rounded">
    <a href="{{route('admin.question.oracionimagen.index')}}"><button class="btn btn-info m-3">Volver al menú principal</button></a>
</div>
<div class="card">
    ...
    @endif
    <div class="card-body">
        <form action="{{route('admin.question.oracionimagen.update', $oracionimagen)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{method_field('PUT')}}

            <div class="form-group">
                <label>Enunciado de pregunta:</label>
                <input type="text" name="title" id="title" placeholder="Ingrese el enunciado de pregunta" value="{{$oracionimagen->title}}" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" placeholder="Slug de la pregunta" value="{{$oracionimagen->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="evaluation_id" id="evaluation_id" class="form-control" required>
                    @foreach ($evaluations as $evaluation)
                        <option value="{{$evaluation->id}}" @if($evaluation->id==$oracionimagen->evaluation_id) selected @endif>{{$evaluation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <br>
                <textarea name="rule" id="rule" class="form-control" value="{{$oracionimagen->rule}}">{{$oracionimagen->rule}}</textarea>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($oracionimagen->image)
                                <img id="picture" src="/storage/{{$oracionimagen->image}}" alt="">
                            @else 
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($oracionimagen->answers as $key=>$answer)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($oracionimagen->indications as $indication)
                    <br>
            ...
            <div class="form-group">
                ...
                <br>
                @foreach ($oracionimagen->justifications as $justification)
                    <br>
