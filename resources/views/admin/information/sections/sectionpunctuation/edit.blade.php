...
@section('content_header')
    <h1>Editar regla ortográfica de puntuación nivel dos</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.sections.sectionpunctuation.update', $sectionpunctuation)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$sectionpunctuation->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$sectionpunctuation->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="form-control" required>
                    ...
                    @foreach ($categories as $categorypunctuation)
                        <option value="{{$categorypunctuation->id}}" @if($categorypunctuation->id === $sectionpunctuation->category_id) selected @endif>{{$categorypunctuation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($sectionpunctuation->image)
                                <img id="picture" src="/storage/{{$sectionpunctuation->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$sectionpunctuation->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$sectionpunctuation->description}}">{{$sectionpunctuation->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$sectionpunctuation->body}}">{{$sectionpunctuation->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$sectionpunctuation->example}}">{{$sectionpunctuation->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$sectionpunctuation->exception}}">{{$sectionpunctuation->exception}}</textarea>
