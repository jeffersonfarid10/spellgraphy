...
@section('content_header')
    <h1>Editar regla ortográfica de acentuación nivel dos</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.sections.sectionacentuation.update', $sectionacentuation)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$sectionacentuation->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$sectionacentuation->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="form-control" required>
                    ...
                    @foreach ($categories as $categoryacentuation)
                        <option value="{{$categoryacentuation->id}}" @if($categoryacentuation->id === $sectionacentuation->category_id) selected @endif>{{$categoryacentuation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($sectionacentuation->image)
                                <img id="picture" src="/storage/{{$sectionacentuation->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$sectionacentuation->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$sectionacentuation->description}}">{{$sectionacentuation->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$sectionacentuation->body}}">{{$sectionacentuation->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$sectionacentuation->example}}">{{$sectionacentuation->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$sectionacentuation->exception}}">{{$sectionacentuation->exception}}</textarea>
