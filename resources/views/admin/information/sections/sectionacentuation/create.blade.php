...
@section('content_header')
    <h1>Crear regla ortográfica de acentuación nivel dos</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.sections.sectionacentuation.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($sectionacentuation->image)
                                    <img id="picture" src="{{Storage::url($sectionacentuation->image)}}" alt="">
