...
@section('content_header')
    <h1>Crear regla ortográfica de palabras nivel dos</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.sections.sectionword.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="form-group">
                    ...
                    <select name="category_id" id="category_id" class="form-control" required>
                        ...
                        @foreach ($categories as $categoryword)
                            <option value="{{$categoryword->id}}">{{$categoryword->name}}</option>
                        @endforeach
                    </select>
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($sectionword->image)
                                    <img id="picture" src="{{Storage::url($sectionword->image)}}" alt="">
