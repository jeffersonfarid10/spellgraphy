...
@section('content_header')
    <h1>Editar regla ortográfica de palabras nivel dos</h1>
@stop

@section('content')
    
<div class="bg-dark text-white font-bold rounded">
    <a href="{{route('admin.sections.sectionword.index')}}">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.sections.sectionword.update', $sectionword)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$sectionword->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$sectionword->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="category_id" id="category_id" class="form-control" required>
                    ...
                    @foreach ($categories as $categoryword)
                        <option value="{{$categoryword->id}}" @if($categoryword->id === $sectionword->category_id) selected @endif>{{$categoryword->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($sectionword->image)
                                <img id="picture" src="/storage/{{$sectionword->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$sectionword->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$sectionword->description}}">{{$sectionword->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$sectionword->body}}">{{$sectionword->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$sectionword->example}}">{{$sectionword->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$sectionword->exception}}">{{$sectionword->exception}}</textarea>
