        ...
        <div class="card-body">
            ...
            @isset($sectionword->description)
                <div>
                    ...
                    <br>
                    <p class="card-text">{!!$sectionword->description!!}</p>
                </div>
            @endisset
            ...
            @isset($sectionword->example)
                <div>
                    <strong>Ejemplos:</strong>
                    <br>
                    <p class="card-text">{!!$sectionword->example!!}</p>
                </div>
            @endisset
            ...
            @isset($sectionword->exception)
                <div>
                    <strong>Excepciones:</strong>
                    <br>
                    <p class="card-text">{!!$sectionword->exception!!}</p>
                </div>
            @endisset
            ...
            @if (count($sectionword->words) > 0)
                <div>
                    <strong>Términos asociados:</strong>
                    <br>
                    @foreach ($sectionword->words as $word)
