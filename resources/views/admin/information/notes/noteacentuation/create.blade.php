...
@section('content_header')
    <h1>Crear regla ortográfica de acentuación nivel cinco</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.notes.noteacentuation.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="form-group">
                    ...
                    <select name="rule_id" id="rule_id" class="form-control" required>
                        ...
                        @foreach ($rules as $ruleacentuation)
                            <option value="{{$ruleacentuation->id}}">{{$ruleacentuation->name}}</option>
                        @endforeach
                    </select>
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($noteacentuation->image)
                                    <img id="picture" src="{{Storage::url($noteacentuation->image)}}" alt="">
