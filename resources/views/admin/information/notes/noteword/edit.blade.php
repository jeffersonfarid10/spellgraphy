...
@section('content_header')
    <h1>Editar regla ortográfica de palabras nivel cinco</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.notes.noteword.update', $noteword)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$noteword->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$noteword->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="rule_id" id="rule_id" class="form-control" required>
                    ...
                    @foreach ($rules as $ruleword)
                        <option value="{{$ruleword->id}}" @if($ruleword->id === $noteword->rule_id) selected @endif>{{$ruleword->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($noteword->image)
                                <img id="picture" src="/storage/{{$noteword->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$noteword->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$noteword->description}}">{{$noteword->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$noteword->body}}">{{$noteword->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$noteword->example}}">{{$noteword->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$noteword->exception}}">{{$noteword->exception}}</textarea>
