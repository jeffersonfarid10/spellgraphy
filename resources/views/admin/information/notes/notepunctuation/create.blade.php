...
@section('content_header')
    <h1>Crear regla ortográfica de puntuación nivel cinco</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.notes.notepunctuation.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="form-group">
                    ...
                    <select name="rule_id" id="rule_id" class="form-control" required>
                        ...
                        @foreach ($rules as $rulepunctuation)
                            <option value="{{$rulepunctuation->id}}">{{$rulepunctuation->name}}</option>
                        @endforeach
                    </select>
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($notepunctuation->image)
                                    <img id="picture" src="{{Storage::url($notepunctuation->image)}}" alt="">
