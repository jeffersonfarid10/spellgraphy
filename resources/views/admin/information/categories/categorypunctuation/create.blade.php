...
@section('content_header')
    <h1>Crear regla ortográfica de puntuación nivel uno</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.categories.categorypunctuation.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($categorypunctuation->imagen)
                                    <img id="picture" src="{{Storage::url($categorypunctuation->image)}}" alt="">
