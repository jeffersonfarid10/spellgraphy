...
@section('content_header')
    <h1>Editar regla ortográfica de palabras nivel uno</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.categories.categoryword.update', $categoryword)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{method_field('PUT')}}
            
            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$categoryword->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$categoryword->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($categoryword->image)
                                <img id="picture" src="/storage/{{$categoryword->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$categoryword->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$categoryword->description}}">{{$categoryword->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$categoryword->body}}">{{$categoryword->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$categoryword->example}}">{{$categoryword->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$categoryword->exception}}">{{$categoryword->exception}}</textarea>
