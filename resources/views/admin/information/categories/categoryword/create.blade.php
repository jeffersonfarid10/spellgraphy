...
@section('content_header')
    <h1>Crear regla ortográfica de palabras nivel uno</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.categories.categoryword.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($categoryword->imagen)
                                    <img id="picture" src="{{Storage::url($categoryword->image)}}" alt="">
