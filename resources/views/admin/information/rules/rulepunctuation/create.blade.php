...
@section('content_header')
    <h1>Crear regla ortográfica de puntuación nivel cuatro</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.rules.rulepunctuation.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="form-group">
                    ...
                    <select name="post_id" id="post_id" class="form-control" required>
                        ...
                        @foreach ($posts as $postpunctuation)
                            <option value="{{$postpunctuation->id}}">{{$postpunctuation->name}}</option>
                        @endforeach
                    </select>
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($rulepunctuation->image)
                                    <img id="picture" src="{{Storage::url($rulepunctuation->image)}}" alt="">
