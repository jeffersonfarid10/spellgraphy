...
@section('content_header')
    <h1>Editar regla ortográfica de puntuación nivel cuatro</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.rules.rulepunctuation.update', $rulepunctuation)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$rulepunctuation->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$rulepunctuation->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="post_id" id="post_id" class="form-control" required>
                    ...
                    @foreach ($posts as $postpunctuation)
                        <option value="{{$postpunctuation->id}}" @if($postpunctuation->id === $rulepunctuation->post_id) selected @endif>{{$postpunctuation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($rulepunctuation->image)
                                <img id="picture" src="/storage/{{$rulepunctuation->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$rulepunctuation->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$rulepunctuation->description}}">{{$rulepunctuation->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$rulepunctuation->body}}">{{$rulepunctuation->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$rulepunctuation->example}}">{{$rulepunctuation->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$rulepunctuation->exception}}">{{$rulepunctuation->exception}}</textarea>
