...
@section('content_header')
    <h1>Editar regla ortográfica de palabras nivel cuatro</h1>
@stop

@section('content')

<div class="bg-dark text-white font-bold rounded">
    <a href="{{route('admin.rules.ruleword.index')}}">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.rules.ruleword.update', $ruleword)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$ruleword->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$ruleword->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="post_id" id="post_id" class="form-control" required>
                    ...
                    @foreach ($posts as $postword)
                        <option value="{{$postword->id}}" @if($postword->id === $ruleword->post_id) selected @endif>{{$postword->name}}</option>
                    @endforeach
                </select>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($ruleword->image)
                                <img id="picture" src="/storage/{{$ruleword->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$ruleword->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$ruleword->description}}">{{$ruleword->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$ruleword->body}}">{{$ruleword->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$ruleword->example}}">{{$ruleword->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$ruleword->exception}}">{{$ruleword->exception}}</textarea>
