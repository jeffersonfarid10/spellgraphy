...
<div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <br>
            <h1 class="card-title">{{$ruleword->name}}</h1>
            <br>
            <strong>Regla principal a la que pertenece:</strong>
            <br>
            <h1 class="card-title">{{$ruleword->post->name}}</h1>
            <br>
        </div>
        <br>
        <div class="card-body">
            ...
            @isset($ruleword->image)
                <li class="list-group-item">
                    ...
                    <br>
                    <img id="image" name="image" src="/storage/{{$ruleword->image}}" alt="" height="400px" width="700px">
                </li>
            @endisset
            ...
            @isset($ruleword->description)
                <div>
                    ...
                    <br>
                    <p class="card-text">{!!$ruleword->description!!}</p>
                </div>
            @endisset
            ...
            <div>
                ...
                <br>
                <p class="card-text">{!!$ruleword->body!!}</p>
            </div>
            ...
            @isset($ruleword->example)
                <div>
                    <strong>Ejemplos:</strong>
                    <br>
                    <p class="card-text">{!!$ruleword->example!!}</p>
                </div>
            @endisset
            ...
            @isset($ruleword->exception)
                <div>
                    <strong>Excepciones:</strong>
                    <br>
                    <p class="card-text">{!!$ruleword->exception!!}</p>
                </div>
            @endisset
            ...
            @if (count($ruleword->words) > 0)
                <div>
                    <strong>Términos asociados:</strong>
                    <br>
                    @foreach ($ruleword->words as $word)
