...
@section('content_header')
    <h1>Crear regla ortográfica de palabras nivel cuatro</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.rules.ruleword.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="form-group">
                    ...
                    <select name="post_id" id="post_id" class="form-control" required>
                        ...
                        @foreach ($posts as $postword)
                            <option value="{{$postword->id}}">{{$postword->name}}</option>
                        @endforeach
                    </select>
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($ruleword->image)
                                    <img id="picture" src="{{Storage::url($ruleword->image)}}" alt="">
