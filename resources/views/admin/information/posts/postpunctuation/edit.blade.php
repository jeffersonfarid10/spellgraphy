...
@section('content_header')
    <h1>Editar regla ortográfica de puntuación nivel tres</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.posts.postpunctuation.update', $postpunctuation)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$postpunctuation->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$postpunctuation->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="section_id" id="section_id" class="form-control" required>
                    ...
                    @foreach ($sections as $sectionpunctuation)
                        <option value="{{$sectionpunctuation->id}}" @if($sectionpunctuation->id === $postpunctuation->section_id) selected @endif>{{$sectionpunctuation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($postpunctuation->image)
                                <img id="picture" src="/storage/{{$postpunctuation->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$postpunctuation->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$postpunctuation->description}}">{{$postpunctuation->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$postpunctuation->body}}">{{$postpunctuation->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$postpunctuation->example}}">{{$postpunctuation->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$postpunctuation->exception}}">{{$postpunctuation->exception}}</textarea>
