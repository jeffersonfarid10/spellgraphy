...
@section('content_header')
    <h1>Crear regla ortográfica de palabras nivel tres</h1>
@stop
...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.posts.postword.store')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="form-group">
                    ...
                    <select name="section_id" id="section_id" class="form-control" required>
                        ...
                        @foreach ($sections as $sectionword)
                            <option value="{{$sectionword->id}}">{{$sectionword->name}}</option>
                        @endforeach
                    </select>
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @isset($postword->image)
                                    <img id="picture" src="{{Storage::url($postword->image)}}" alt="">
