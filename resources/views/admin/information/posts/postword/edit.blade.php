...
@section('content_header')
    <h1>Editar regla ortográfica de palabras nivel tres</h1>
@stop

@section('content')

<div class="bg-dark text-white font-bold rounded">
    <a href="{{route('admin.posts.postword.index')}}">
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.posts.postword.update', $postword)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$postword->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$postword->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="section_id" id="section_id" class="form-control" required>
                    ...
                    @foreach ($sections as $sectionword)
                        <option value="{{$sectionword->id}}" @if($sectionword->id === $postword->section_id) selected @endif>{{$sectionword->name}}</option>
                    @endforeach
                </select>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($postword->image)
                                <img id="picture" src="/storage/{{$postword->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$postword->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$postword->description}}">{{$postword->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$postword->body}}">{{$postword->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$postword->example}}">{{$postword->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$postword->exception}}">{{$postword->exception}}</textarea>
