...
@section('content_header')
    <h1>Editar regla ortográfica de acentuación nivel tres</h1>
@stop
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.posts.postacentuation.update', $postacentuation)}}" method="POST" enctype="multipart/form-data">
            @csrf 
            {{ method_field('PUT')}}

            <div class="form-group">
                <label>Título</label>
                <input type="text" name="name" id="name" placeholder="Ingrese el título" value="{{$postacentuation->name}}" class="form-control" required>
            ...
            <div class="form-group">
                <label>Slug:</label>
                <input type="text" name="slug" id="slug" placeholder="Slug de la publicación" value="{{$postacentuation->slug}}" class="form-control" required readonly>
            ...
            <div class="form-group">
                ...
                <select name="section_id" id="section_id" class="form-control" required>
                    ...
                    @foreach ($sections as $sectionacentuation)
                        <option value="{{$sectionacentuation->id}}" @if($sectionacentuation->id === $postacentuation->section_id) selected @endif>{{$sectionacentuation->name}}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="row mb-3">
                    <div class="col">
                        <div class="image-wrapper">
                            ...
                            @isset($postacentuation->image)
                                <img id="picture" src="/storage/{{$postacentuation->image}}" alt="">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <label>Imagen:</label>
                            <input type="file" name="image" id="image" class="form-control-file" accept="image/*" value="{{$postacentuation->image}}" >
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" value="{{$postacentuation->description}}">{{$postacentuation->description}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="body" id="body" class="form-control" value="{{$postacentuation->body}}">{{$postacentuation->body}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="example" id="example" class="form-control" value="{{$postacentuation->example}}">{{$postacentuation->example}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="exception" id="exception" class="form-control" value="{{$postacentuation->exception}}">{{$postacentuation->exception}}</textarea>
