...
<!-- //////////////////////////////////////////////////////NUEVA VISTA ADMIN RESULTADOS TI////////////////////////////////// -->
...
<div class="container-fluid card p-5">
    ...
    <div class="container border border-dark rounded mb-5">
        ...
        <div class="px-5 py-4 border-top border-bottom m-2">
            ...
            <h4 class="text-center m-4">{{$respuestaParrafoUno}}</h4>
        </div>
            ...
            <div class="px-5 py-4 border-top border-bottom m-2">
                ...
                MENSAJE QUE HAY ESPACIOS ADICIONALES EN LA RESPUESTA, PERO SI ES FALSE, ES DECIR NO TIENE ESPACIOS, SOLO SE MUESTRA LA RESPUESTA DEL USUARIO -->
                    @if ($existenespaciosti)
                        ...
                        <h4 class="text-justify m-4"><strong>{{$stringseccionestextotiusuario}}</strong></h4>
        ...
        @if (count($resultadoSeccionesParrafoUsuarioIncorrectas) > 0)
            ...
            <div class="px-5 py-4 border-top border-bottom m-2">
                ...
                @foreach (array_unique($resultadoSeccionesParrafoUsuarioIncorrectas) as $key=>$elemento)
                    <span id="palabrasIncorrectasParrafoUsuario" name="palabrasIncorrectasParrafoUsuario" class="h4 text-center mt-4"><strong>{{$elemento}}</strong></span>
                    <span class="h4 text-red pt-2 mt-2 mb-2 ml-2"><strong> | </strong></span>
        ...
        @if (count($resultadoSignosIncorrectosParrafoUsuario) > 0)
            ...
            <div class="px-5 py-4 border-top border-bottom m-2">
                ...
                @foreach ($resultadoSignosIncorrectosParrafoUsuario as $elemento)
                    <span id="signosIncorrectosParrafoUsuario" name="signosIncorrectosParrafoUsuario" class="h4 text-center mt-4"><strong>{{$elemento}}</strong></span>
                    <span class="h4 text-red pt-2 mt-2 mb-2 ml-2"><strong> | </strong></span>
        ...
        @if (count($resultadoSignosQueLeFaltaronParrafoUsuario) > 0)
            ...
            <div class="px-5 py-4 border-top border-bottom m-2">
                ...
                <span class="h4 text-red pt-2 mt-2 mb-2 ml-2"> | </span>
...
<!-- ////////////////////////////////////////////////////////FIN NUEVA VISTA ADMIN RESULTADOS TI/////////////////////////////////////////// -->
...
@section('js')
    ...
    <!-- SCRIPT JUEGO -->
    <script src="{{asset('/js/resaltartiadmin.js')}}"></script>
@stop