...
<!-- ///////////////////////////////////////////////////////////NUEVA VISTA ADMIN RESULTADOS JA///////////////////////////////// -->
...
<div class="container-fluid card p-5">
    ...
    <div class="container border border-dark rounded">
        ...
        <div class="px-5 py-4 border-top border-bottom m-2">
            <h4 class="text-red mt-2 ml-4 mb-2"><strong>Oración mostrada:</strong></h4>
            <h4 class="text-center m-4">{{$answerCorrecta->visible_answer}}</h4>
        </div>
        <div class="container">
            <div class="row">
...
<!-- ////////////////////////////////////////////////////////////FIN NUEVA VISTA ADMIN RESULTADOS JA/////////////////////////////////////////////// -->
