...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'NOTAS POR TIPO EVALUACIÓN'],
        [
            'text'    => 'Seleccionar Evaluación',
            'icon'    => 'fas fa-fw fa-share',
            'submenu' => [
                [
                    'text' => 'Evaluación Diagnóstico',
                    'route' => 'admin.notes.diagnostic',
                    'icon' => 'fas fa-fw fa-user',
                ],
                [
                    'text' => 'Evaluación Práctica Uno',
                    'route' => 'admin.notes.practiceone',
                    'icon' => 'fas fa-fw fa-user',
                ],
                [
                    'text' => 'Evaluación Práctica Dos',
                    'route' => 'admin.notes.practicetwo',
                    'icon' => 'fas fa-fw fa-user',
                ],
                [
                    'text' => 'Evaluación Práctica Tres',
                    'route' => 'admin.notes.practicethree',
                    'icon' => 'fas fa-fw fa-user',
                ],
                [
                    'text' => 'Evaluación Final',
                    'route' => 'admin.notes.final',
                    'icon' => 'fas fa-fw fa-user',
                ],
